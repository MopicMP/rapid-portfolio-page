# rapid-portfolio-page

> Rapid developer portfolio page template

[![PyPI version](https://badge.fury.io/py/rapid-portfolio-page.svg)](https://pypi.org/project/rapid-portfolio-page/)
...
```bash
pip install rapid-portfolio-page
```

## Quick Start

```python
from rapid_portfolio_page import page
...
from rapid_portfolio_page import batch
